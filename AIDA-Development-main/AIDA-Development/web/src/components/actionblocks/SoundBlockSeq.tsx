              ...
              <div className="bg-slate-700 rounded-lg shadow-lg flex flex-col items-center p-6">
                ...
                <div className="bg-white rounded-lg shadow-lg flex flex-col items-center p-10 m-2">
                  ...
                  <div
                    ...
                    onClick={() => {
                      // Reset to the base "Input Sound" action.  No audio should
                      // play when canceling.
  ...
  return sounds.map((sound, index) => (
    <div
      ...
      onClick={() => {
        ...
        // Play the selected sound immediately when the user picks it in the
        // popup.  Reset the currentTime before playing to ensure it starts
        // from the beginning each time.
        if (sound.audioFile) {
          try {
            sound.audioFile.currentTime = 0;

            sound.audioFile.play().catch((err) => {
