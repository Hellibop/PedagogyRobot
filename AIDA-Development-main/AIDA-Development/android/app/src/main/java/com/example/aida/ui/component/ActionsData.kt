...
val actionUIDataMap: HashMap<RobotActionType, ActionUIData> = hashMapOf(
    ...
    RobotActionType.IF_START to ActionUIData("IF", Icons.Outlined.CheckCircle),
    RobotActionType.IF_ELSE to ActionUIData("IF ELSE", Icons.Outlined.Cancel),
    RobotActionType.IF_END to ActionUIData("IF END", Icons.Outlined.Remove),
